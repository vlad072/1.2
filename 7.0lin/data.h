...
#define DOOR_TAIL   0xF1
#define WIND_TAIL   0xF9
#define END_TAIL    0xF8
//================= moto func actions====================
...
const char* fwver   = "7.0";            // firmware version
//===================== variables ======================
...
uint16_t moto(uint8_t act = READ_MOTO, uint16_t val = 1) {                   // 3C0..3FF ==== page 25  =====
