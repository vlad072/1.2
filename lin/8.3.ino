...
void dsupdate() {
  ...
  if ( (secure & 0xA0) == 0xA0 )                                              // overheats:
    if ( (temps[DIF][PCB]  > 1) || (temps[CUR][PCB]  > 70) ||  //   pcb
         (temps[DIF][OUT] > (timeover(tengrun, 900000ul) ? (timeover(tengrun, 7200000ul) ? 1 : 2) : 3)) || (temps[CUR][OUT] > 65) ||  //   outside /15min=3C 2h=2C
         (temps[DIF][VEH]  > 1) || (temps[CUR][VEH]  > 80) )   //   vehicle
