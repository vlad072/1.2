...
void locking(bool lk) {
  if (setupmode) return;
  if (lk) {                   // lock
    if (door.active() || hood.active()) siren.twitch(100ul, 3); else if (secure & 0x04) siren.set(1), _delay_ms(70), siren.set(0);
    ...
    if (secure & 0x04)
      ...
      else if (alarm & 0x01)  siren.twitch(70ul,  2);
      else                    siren.set(1), _delay_ms(70), siren.set(0);
