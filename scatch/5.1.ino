...
void exec(const char* topic, const char* payl) { //++++++++++++++  USER COMMAND IMPLEMENTAION  ++++++++++++++++++
  ...
  if        (!strcmp(topic, "wutm"))  {   //*************** warmup timer **************
    ...
    if (sendstart()) pub("inf/engr", pump.active() ? "1" : "0"), pubf("inf/wutm", warmtimer, 0), pubf("inf/wutp", warmtemp, 0), sendfin();
    ...
    switch (payl[0]) {
      ...
      case '3': if (secure & 0x04) siren.twitch(500ul, 3); flash.twitch(3000ul);     // raise
    }
